...
Performance typically increases with numbers of processes to a certain point. Example results for two 8 node runs, the first with 2 cores/node and the second with 8 processes/node are as follows:
.. code-block:: bash
