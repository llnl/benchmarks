...
. ./env--elcapitan--miniem.sh

# Runtime switches
export MINIEM_TAG="${MINIEM_TAG:-interactive}"
...
# app_exe="/rlfs01/amagela/fcr/miniem/eldorado/install/amd-6.4.3_prgenv-amd_rocm-6.4.3_mpich-9.0.1_pure-amd_hip_amd-NOinlall-NOfunc-gfx942_devtpls_opt-g_cxx20_libonly_static/trilinos/example/PanzerMiniEM/PanzerMiniEM_BlockPrec.exe"
...
flux run \
    ...
    "${app_exe}" \
        ...
        1>"${MINIEM_TAG}.out" 2>"${MINIEM_TAG}.err"
